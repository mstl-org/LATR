...
# 文件夹路径
base_dir = '/media/home/data_share/OpenLane/waymo/data/results/data_final/vis_results_20250704/'
...
json_file = all_files[22][25]  # 你可以根据需要修改索引
