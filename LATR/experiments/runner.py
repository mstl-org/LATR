...
class Runner:
    ...
    def validate(self, model, **kwargs):
        ...
        with torch.no_grad():
            ...
            for i, extra_dict in enumerate(loader):
                ...
                all_line_preds = output['all_line_preds'] # in ground coordinate system #(2,4,40,21)
                all_cls_scores = output['all_cls_scores'] #(2,4,40,60)
    ...
    def _get_train_dataset(self):
        args = self.args
        if 'openlane' in args.dataset_name:
            train_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'training/', args.train_pkl, args, data_aug=False)
    ...
    def _get_valid_dataset(self):
        ...
        if 'openlane' in args.dataset_name:
            if not args.evaluate_case:
                valid_dataset = LaneDataset(args.dataset_dir, args.data_dir + 'validation/', args.val_pkl, args)
            else:
                # TODO eval case
